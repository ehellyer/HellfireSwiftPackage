...
public protocol OptionalEncodable: Encodable, OptionalEncodingWrapper where WrappedType == EncoderWrapper.CustomEncoder.EncodedType? {
...
public struct OptionalEncoding<CustomEncoderWrapper: StaticEncoderWrapper>: OptionalEncodable {
    ...
    public var wrappedValue: CustomEncoderWrapper.CustomEncoder.EncodedType?
    public init(wrappedValue: CustomEncoderWrapper.CustomEncoder.EncodedType?) {
...
public struct OptionalCoding<CustomCoderWrapper: StaticCodingWrapper>: OptionalCodable {
    ...
    public var wrappedValue: CustomCoderWrapper.CustomEncoder.EncodedType?
...
extension OptionalEncoding: Decodable, TransientDecodable where CustomEncoderWrapper.CustomEncoder.EncodedType: Decodable { }

/// Ensures there isn't an extra level added
extension OptionalDecoding: Encodable, TransientEncodable where CustomDecoderWrapper.CustomDecoder.DecodedType: Encodable { }

//MARK: - OptionalCoding Equatable Conformance

extension OptionalEncoding: Equatable where CustomEncoderWrapper.CustomEncoder.EncodedType: Equatable {}
extension OptionalDecoding: Equatable where CustomDecoderWrapper.CustomDecoder.DecodedType: Equatable {}
extension OptionalCoding: Equatable where CustomCoderWrapper.CustomEncoder.EncodedType: Equatable {}


//MARK: - OptionalCoding Hashable Conformance
extension OptionalEncoding: Hashable where CustomEncoderWrapper.CustomEncoder.EncodedType: Hashable {}
extension OptionalDecoding: Hashable where CustomDecoderWrapper.CustomDecoder.DecodedType: Hashable {}
extension OptionalCoding: Hashable where CustomCoderWrapper.CustomEncoder.EncodedType: Hashable {}
